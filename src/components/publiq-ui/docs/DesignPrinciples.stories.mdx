...
Every Bootstrap component we use in React should be wrapped in a custom component inside the publiq-ui folder.
...
The root font size is defined once globally and should not be overridden in specific components. Use the `rem` unit as much as possible for other values like margins, paddings, etc.
