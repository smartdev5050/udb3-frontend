    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 481 409">
        <g fill="none">
          ...
          <path
            fill="#F19E4A"
            d="M45.97 240.67c0-7.94.43-15.8 1.25-23.53l-36.03 2.08-10.7 17.94A239.13 239.13 0 0 0 65.1 404.54a7.86 7.86 0 0 0 11.28.15l21.15-21.15c-32.34-39.59-51.57-89.11-51.57-142.87Z"
          />
          <path
            fill="#FAD071"
            d="m131.7 126.72.5.52a156.28 156.28 0 0 0-48.54 109.92H.5v-.47c1.08-65.96 28.95-125.4 73.06-168.12l.23.23 57.92 57.92Z"
          />
          <path
            fill="#F8D448"
