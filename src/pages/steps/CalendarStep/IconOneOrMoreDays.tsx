const IconOneOrMoreDays = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="50" viewBox="0 0 64 64">
      <path
        fill="#f0f0f0"
        d="M57 9h-6v3a3 3 0 0 1-6 0V9H35v3a3 3 0 0 1-6 0V9H19v3a3 3 0 0 1-6 0V9H7a4 4 0 0 0-4 4v8h58v-8a4 4 0 0 0-4-4z"
      />
      <rect width="6" height="5" x="23" y="28" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="11" y="28" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="47" y="28" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="23" y="37" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="11" y="37" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="23" y="46" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="35" y="28" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="35" y="37" fill="#f0f0f0" rx="1" />
      <rect width="6" height="5" x="11" y="46" fill="#f0f0f0" rx="1" />
      <circle cx="49" cy="49" r="12" fill="#f0f0f0" />
      <g fill="#999">
